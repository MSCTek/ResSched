...
namespace CodeGenHero.ResourceScheduler.Model.RS
{
	...
	public partial class User : BaseModel<IWebApiDataServiceRS>, IUser
	{
		...
		public User(ILoggingService log, IDataService<IWebApiDataServiceRS> dataService) : base(log, dataService)
		{
			_dto = new xDTO.User();
			OnLazyLoadRequest += HandleLazyLoadRequest;
		}

		public User(ILoggingService log, IDataService<IWebApiDataServiceRS> dataService, xDTO.User dto) : this(log, dataService)
		{
			_dto = dto;
		}
		...
		public virtual string InstallationId { get { return _dto.InstallationId; } }
		public virtual bool IsActive { get { return _dto.IsActive; } }
		public virtual bool IsDeleted { get { return _dto.IsDeleted; } }
		public virtual System.DateTime? LastLoginDate { get { return _dto.LastLoginDate; } }
			...
			get
			{
				...
				{	// The core DTO object is loaded, but this property is not loaded.
					...
					{	// Trigger the load data request - The core DTO object is loaded and does not have data for this property.
						OnLazyLoadRequest(this, new LoadRequestUser(nameof(ResourceSchedules)));
					}
				}
