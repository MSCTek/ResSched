...
using CodeGenHero.ResourceScheduler.Repository;
...
namespace CodeGenHero.ResourceScheduler.API.Controllers.RS
{
	...
	[RoutePrefix("api/RS")]
	public abstract partial class RSBaseApiController : ApiController, ILoggingService
	{
		private ILoggingService _log;
		private IRSRepository _repository;
		...
		protected IRSRepository Repo { get { return _repository; } }
