...
{
	public partial class RSAPIStatusController : RSBaseApiController
	{
		public RSAPIStatusController() : base()
		{
		}
		...
		[HttpGet]
		[VersionedRoute(template: "APIStatus", allowedVersion: 1, Name = "RSAPIStatus")]
