...
namespace CodeGenHero.ResourceScheduler.API.Controllers.RS
{
	public partial class UsersRSController : RSBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entRS.User newDBItem, ref IRepositoryActionResult<entRS.User> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entRS.User updatedDBItem, ref IRepositoryActionResult<entRS.User> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entRS.User updatedDBItem, ref IRepositoryActionResult<entRS.User> result) {}
