...
{
	public partial class RSRepository : RSRepositoryBase, IRSRepository
	{
		private RSDataContext _ctx;

		public RSRepository(RSDataContext ctx) : base(ctx)
		{
			_ctx = ctx;
		...
		public RSDataContext RSDataContext { get { return _ctx; } }
