...
namespace CodeGenHero.ResourceScheduler.API.Controllers.RS
{
	public partial class ResourcesRSController : RSBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entRS.Resource newDBItem, ref IRepositoryActionResult<entRS.Resource> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entRS.Resource updatedDBItem, ref IRepositoryActionResult<entRS.Resource> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entRS.Resource updatedDBItem, ref IRepositoryActionResult<entRS.Resource> result) {}
